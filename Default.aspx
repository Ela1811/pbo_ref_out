...
<body>
    <form id="form1" runat="server">
            <table>
                ...
                <tr>
                    <td class="auto-style7"><p align="right">Dokter ID&nbsp;&nbsp;&nbsp; </p></td>
            ...
            <table>
                <tr>
                    <td class="auto-style5">
                        <center><h1 class="auto-style4">Show all Dokter Data</h1></center>
                    </td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <tr>
                    <td class="auto-style7"><p align="right">Dokter ID&nbsp;&nbsp;&nbsp; </p></td>
                    <td class="auto-style1">:&nbsp;&nbsp;<asp:TextBox ID="txtDoktID" runat="server"></asp:TextBox>
                    </td>
                        <br />
                    </td>
                    <td>
