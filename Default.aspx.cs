...
namespace Tugas_PBO
{
    public partial class Dokter : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else if (SqlDBHelper.ExecuteNonQuery("Delete from dokter where id_dokter=@id_dokter", CommandType.Text, new NpgsqlParameter("@id_dokter", Convert.ToInt32(txtDoktID.Text))))
            {
                txtDoktID.Text = "";
                GridView1.Visible = false;
                lblmsg.Text = String.Empty;
